...
import RatingModal from "@/components/rating_modal/RatingModal";
import BackDrop from "@/components/back_drop/BackDrop";
...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  const reviewSubmitHandler = async () => {
    if (!ratingText.trim().length || !ratingValue) {
      return toast.error("Please provide a rating and review");
    }
