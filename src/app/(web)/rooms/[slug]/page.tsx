...
import HotelPhotoGallery from "@/components/hotel_photo_gallery/HotelPhotoGallery";
import BookRoomCta from "@/components/book_room_cta/BookRoomCta";
import { useState } from "react";
import axios from "axios";
import { getStripe } from "@/libs/stripe";
import RoomReview from "@/components/room_review/RoomReview";
        ...
        <div className="md:grid md:grid-cols-12 gap-10 px-3">
          <div className="md:col-span-8 md:w-full">
            <div>
              ...
              <div className="mb-11">
                <h2 className="font-bold text-3xl mb-2">Sefety And Hygiene</h2>
                <div className="grid grid-cols-2">
